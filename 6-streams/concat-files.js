...
exports.concatFiles = void 0;
var fs_1 = require("fs");
var stream_1 = require("stream");
function concatFiles(dest, files) {
    return new Promise(function (resolve, reject) {
        var destStream = fs_1.createWriteStream(dest);
        stream_1.Readable.from(files) // (1)
            .pipe(new stream_1.Transform({
            objectMode: true,
            transform: function (filename, enc, done) {
                var src = fs_1.createReadStream(filename);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, concatFiles(process.argv[2], process.argv.slice(3))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
